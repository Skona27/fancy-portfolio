...
export const aboutMe: Record<Languages, AboutMe> = {
  pl: {
    ...
    subtitle: `Cześć! Nazywam się <strong>Jakub Skoneczny</strong> i jestem <em>Javascript Developerem!</em>`,
  ...
  "en-US": {
    ...
    subtitle: `Hi! My name is <strong>Jakub Skoneczny</strong> and I am a <em>Javascript Developer!</em>`,
    text: `
